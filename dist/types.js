...
export var GTFSMergeStrategy;
(function (GTFSMergeStrategy) {
    GTFSMergeStrategy[GTFSMergeStrategy["OVERWRITE"] = 0] = "OVERWRITE";
    GTFSMergeStrategy[GTFSMergeStrategy["IGNORE"] = 1] = "IGNORE";
    GTFSMergeStrategy[GTFSMergeStrategy["THROW"] = 2] = "THROW"; // Throw error if ID exists
})(GTFSMergeStrategy || (GTFSMergeStrategy = {}));
// Helper fns
